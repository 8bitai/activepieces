...
export enum AppSystemProp {
    ...
    NEUTRINO_GATEWAY_URL = 'NEUTRINO_GATEWAY_URL',
    NEUTRINO_GATEWAY_VALIDATE_PATH = 'NEUTRINO_GATEWAY_VALIDATE_PATH',
    EMBED_AUTH_VIA_NEUTRINO_GATEWAY = 'EMBED_AUTH_VIA_NEUTRINO_GATEWAY',
    EMBED_PLATFORM_ID = 'EMBED_PLATFORM_ID',
    EMBED_SESSION_COOKIE_NAME = 'EMBED_SESSION_COOKIE_NAME',
}
